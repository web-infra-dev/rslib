...
| Output format   | `import.meta.env`                           | `process.env.*`                                             |
| --------------- | ------------------------------------------- | ----------------------------------------------------------- |
| ESM             | Preserved                                   | Preserved                                                   |
| CJS             | Replaced with `undefined` with a warning    | Preserved                                                   |
| UMD / IIFE / MF | Rsbuild's default preset values are inlined | The `BASE_URL` and `ASSET_PREFIX` preset values are inlined |
