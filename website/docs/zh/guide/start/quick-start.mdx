...
`create-rslib` 可以帮助你设置一些常用的格式化程序和 linter 工具，包括 [Biome](https://biomejs.dev/)、[ESLint](https://eslint.org/) 和 [prettier](https://prettier.io/)。你可以使用箭头键和空格键进行选择。如果你不需要这些工具，只需按 Enter 跳过即可。
