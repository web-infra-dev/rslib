---
description: 'Use Rstest with Rslib for unit tests, component tests, debugging, and ecosystem-aligned testing workflows.'
---
...
Newly created Rslib projects use Rstest as the test framework by default. See [Creating an Rslib project](https://v0.rslib.rs/guide/start/quick-start#creating-an-rslib-project) for details. You can create a React project with:
