---
description: '在 Rslib 项目中使用 Rstest，涵盖单元测试、组件测试、调试能力与生态一致的测试工作流实践。'
---
...
新创建的 Rslib 项目默认使用 Rstest 作为测试框架，详情参考 [创建 Rslib 项目](https://v0.rslib.rs/zh/guide/start/quick-start#创建-rslib-项目)。你可以通过以下命令创建一个 React 项目：
