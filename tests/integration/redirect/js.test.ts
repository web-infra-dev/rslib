...
test('redirect.js default', async () => {
  ...
  expect(indexContent).toMatchInlineSnapshot(`
    ...
    const src = default_0.toUpper(foo + bar + foo + bar + baz + typeof default_1.version);
...
test('redirect.js.path false', async () => {
  ...
  expect(indexContent).toMatchInlineSnapshot(`
    ...
    import { foo } from "@/foo";
    import { baz } from "~/baz";
    import { bar as bar_0 } from "./bar.js";
    import { foo as foo_0 } from "./foo.js";
    const src = default_0.toUpper(foo_0 + bar_0 + foo + bar + baz + typeof default_1.version);
    export { src as default };
    "
  `);
});
...
test('redirect.js.path with user override externals', async () => {
  ...
  expect(indexContent).toMatchInlineSnapshot(`
    ...
    import { baz } from "./baz.js";
    import { bar as bar_0 } from "./bar/index.js";
    import { foo as foo_0 } from "./foo.js";
    const src = default_0.toUpper(foo_0 + bar_0 + foo + bar + baz + typeof default_1.version);
    export { src as default };
    "
