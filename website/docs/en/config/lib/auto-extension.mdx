...
When [`bundle`](/config/lib/bundle) is set to `false` that as known as bundleless mode, you should write full path instead of ignoring main file in source code.
