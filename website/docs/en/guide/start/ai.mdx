...
[llms.txt](https://llmstxt.org/) is a standard that helps LLMs discover and use project documentation. Rslib follows this standard and publishes a structured index file for its docs.

```
https://rslib.rs/llms.txt
```

You can provide the URL above directly to AI (for example, paste it into the chat or include it in a context configuration file). AI can then use this file to retrieve the full and up-to-date Rslib documentation, which helps it answer questions and generate code more accurately.
