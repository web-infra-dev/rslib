...
describe('dts redirect with tsgo', () => {
  ...
  test('redirect.dts.path: true with redirect.dts.extension: true - default', async () => {
    expect(contents.esm0).toMatchInlineSnapshot(`
      ...
      ",
        "<ROOT>/tests/integration/redirect/dts/dist-tsgo/default/esm/.hidden.d.ts": "export declare const hidden = "This is a hidden file";
      ",
        "<ROOT>/tests/integration/redirect/dts/dist-tsgo/default/esm/a.b/index.d.ts": "export declare const ab = "a.b";
      ",
  ...
  test('redirect.dts.path: false with redirect.dts.extension: false', async () => {
    expect(contents.esm1).toMatchInlineSnapshot(`
      {
        "<ROOT>/tests/integration/redirect/dts/dist-tsgo/path-false/esm/.hidden-folder/index.d.ts": "export declare const hiddenFolder = "This is a hidden folder";
      ",
        "<ROOT>/tests/integration/redirect/dts/dist-tsgo/path-false/esm/.hidden.d.ts": "export declare const hidden = "This is a hidden file";
      ",
        "<ROOT>/tests/integration/redirect/dts/dist-tsgo/path-false/esm/a.b/index.d.ts": "export declare const ab = "a.b";
      ",
        "<ROOT>/tests/integration/redirect/dts/dist-tsgo/path-false/esm/bar.baz.d.ts": "export declare const bar = "bar-baz";
      ",
        "<ROOT>/tests/integration/redirect/dts/dist-tsgo/path-false/esm/config.d.ts": "export * from './config/load';
      ",
      ...
      export { logRequest, logRequest2, logger };
      ",
        "<ROOT>/tests/integration/redirect/dts/dist-tsgo/path-false/esm/foo/index.d.ts": "export type Barrel = string;
      ",
      ...
      export * from './types';
      ",
        "<ROOT>/tests/integration/redirect/dts/dist-tsgo/path-false/esm/logger.d.ts": "import type { Request } from 'express';
      import type { LoggerOptions } from './types';
      export declare function logRequest(req: Request, options: LoggerOptions): void;
      ",
        "<ROOT>/tests/integration/redirect/dts/dist-tsgo/path-false/esm/types.d.ts": "export interface LoggerOptions {
          logLevel: 'info' | 'debug' | 'warn' | 'error';
          logBody: boolean;
      }
      export declare const defaultOptions: LoggerOptions;
  ...
  test('redirect.dts.path: false with dts.redirect.extension: true', async () => {
    expect(contents.esm3).toMatchInlineSnapshot(`
      {
        "<ROOT>/tests/integration/redirect/dts/dist-tsgo/path-false-extension-true/esm/.hidden-folder/index.d.ts": "export declare const hiddenFolder = "This is a hidden folder";
      ",
        "<ROOT>/tests/integration/redirect/dts/dist-tsgo/path-false-extension-true/esm/.hidden.d.ts": "export declare const hidden = "This is a hidden file";
      ",
        "<ROOT>/tests/integration/redirect/dts/dist-tsgo/path-false-extension-true/esm/a.b/index.d.ts": "export declare const ab = "a.b";
      ",
        "<ROOT>/tests/integration/redirect/dts/dist-tsgo/path-false-extension-true/esm/bar.baz.d.ts": "export declare const bar = "bar-baz";
      ",
        "<ROOT>/tests/integration/redirect/dts/dist-tsgo/path-false-extension-true/esm/config.d.ts": "export * from './config/load.js';
      ",
      ...
      export { logRequest, logRequest2, logger };
      ",
        "<ROOT>/tests/integration/redirect/dts/dist-tsgo/path-false-extension-true/esm/foo/index.d.ts": "export type Barrel = string;
      ",
      ...
      export * from './types.js';
      ",
        "<ROOT>/tests/integration/redirect/dts/dist-tsgo/path-false-extension-true/esm/logger.d.ts": "import type { Request } from 'express';
      import type { LoggerOptions } from './types.js';
      export declare function logRequest(req: Request, options: LoggerOptions): void;
      ",
        "<ROOT>/tests/integration/redirect/dts/dist-tsgo/path-false-extension-true/esm/types.d.ts": "export interface LoggerOptions {
          logLevel: 'info' | 'debug' | 'warn' | 'error';
          logBody: boolean;
      }
      export declare const defaultOptions: LoggerOptions;
  ...
  test('redirect.dts.extension: true with dts.autoExtension: true', async () => {
    expect(contents.esm4).toMatchInlineSnapshot(`
      {
        "<ROOT>/tests/integration/redirect/dts/dist-tsgo/auto-extension-true/esm/.hidden-folder/index.d.mts": "export declare const hiddenFolder = "This is a hidden folder";
      ",
        "<ROOT>/tests/integration/redirect/dts/dist-tsgo/auto-extension-true/esm/.hidden.d.mts": "export declare const hidden = "This is a hidden file";
      ",
        "<ROOT>/tests/integration/redirect/dts/dist-tsgo/auto-extension-true/esm/a.b/index.d.mts": "export declare const ab = "a.b";
      ",
        "<ROOT>/tests/integration/redirect/dts/dist-tsgo/auto-extension-true/esm/bar.baz.d.mts": "export declare const bar = "bar-baz";
      ",
        "<ROOT>/tests/integration/redirect/dts/dist-tsgo/auto-extension-true/esm/config.d.mts": "export * from './config/load.mjs';
      ",
      ...
      export { logRequest, logRequest2, logger };
      ",
        "<ROOT>/tests/integration/redirect/dts/dist-tsgo/auto-extension-true/esm/foo/index.d.mts": "export type Barrel = string;
      ",
      ...
      ",
        "<ROOT>/tests/integration/redirect/dts/dist-tsgo/auto-extension-true/esm/logger.d.mts": "import type { Request } from 'express';
      import type { LoggerOptions } from './types.mjs';
      export declare function logRequest(req: Request, options: LoggerOptions): void;
      ",
        "<ROOT>/tests/integration/redirect/dts/dist-tsgo/auto-extension-true/esm/types.d.mts": "export interface LoggerOptions {
          logLevel: 'info' | 'debug' | 'warn' | 'error';
          logBody: boolean;
      }
      export declare const defaultOptions: LoggerOptions;
    ...
    expect(contents.cjs).toMatchInlineSnapshot(`
      {
        "<ROOT>/tests/integration/redirect/dts/dist-tsgo/auto-extension-true/cjs/.hidden-folder/index.d.ts": "export declare const hiddenFolder = "This is a hidden folder";
      ",
        "<ROOT>/tests/integration/redirect/dts/dist-tsgo/auto-extension-true/cjs/.hidden.d.ts": "export declare const hidden = "This is a hidden file";
      ",
        "<ROOT>/tests/integration/redirect/dts/dist-tsgo/auto-extension-true/cjs/a.b/index.d.ts": "export declare const ab = "a.b";
      ",
        "<ROOT>/tests/integration/redirect/dts/dist-tsgo/auto-extension-true/cjs/bar.baz.d.ts": "export declare const bar = "bar-baz";
      ",
        "<ROOT>/tests/integration/redirect/dts/dist-tsgo/auto-extension-true/cjs/config.d.ts": "export * from './config/load.js';
      ",
      ...
      export { logRequest, logRequest2, logger };
      ",
        "<ROOT>/tests/integration/redirect/dts/dist-tsgo/auto-extension-true/cjs/foo/index.d.ts": "export type Barrel = string;
      ",
      ...
      export * from './types.js';
      ",
        "<ROOT>/tests/integration/redirect/dts/dist-tsgo/auto-extension-true/cjs/logger.d.ts": "import type { Request } from 'express';
      import type { LoggerOptions } from './types.js';
      export declare function logRequest(req: Request, options: LoggerOptions): void;
      ",
        "<ROOT>/tests/integration/redirect/dts/dist-tsgo/auto-extension-true/cjs/types.d.ts": "export interface LoggerOptions {
          logLevel: 'info' | 'debug' | 'warn' | 'error';
          logBody: boolean;
      }
      export declare const defaultOptions: LoggerOptions;
