...
1. Install the dependencies for Storybook Rsbuild React framework. The essential ones include
   ...
   <PackageManagerTabs
     command={{
       npm: 'npm add storybook @storybook/addon-essentials@next storybook-addon-rslib @rsbuild/core -D',
       yarn: 'yarn add storybook @storybook/addon-essentials@next storybook-addon-rslib @rsbuild/core -D',
       pnpm: 'pnpm add storybook @storybook/addon-essentials@next storybook-addon-rslib @rsbuild/core -D',
       bun: 'bun add storybook @storybook/addon-essentials@next storybook-addon-rslib @rsbuild/core -D',
     }}
   />
