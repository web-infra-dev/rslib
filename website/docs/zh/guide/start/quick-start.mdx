...
创建的 Rslib 项目默认使用 [Rstest](https://rstest.rs/zh/) 作为测试框架，阅读 [使用 Rstest](/guide/advanced/rstest) 了解更多信息。
...
| [React Compiler](/zh/guide/solution/react#react-compiler) | 优化 React 组件，仅 React 模板       |
