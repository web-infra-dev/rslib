...
<PackageManagerTabs
  command={{
    npm: 'npm add storybook-react-rsbuild  -D',
    yarn: 'yarn add storybook-react-rsbuild  -D',
    pnpm: 'pnpm add storybook-react-rsbuild  -D',
    bun: 'bun add storybook-react-rsbuild  -D',
  }}
/>
...
<PackageManagerTabs
  command={{
    npm: 'npm add storybook-vue-rsbuild  -D',
    yarn: 'yarn add storybook-vue-rsbuild  -D',
    pnpm: 'pnpm add storybook-vue-rsbuild  -D',
    bun: 'bun add storybook-vue-rsbuild  -D',
  }}
/>
