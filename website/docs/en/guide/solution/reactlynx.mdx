...
<PackageManagerTabs
  command={{
    ...
    deno: 'deno init --npm @lynx-js/lynx@latest',
  }}
/>
...
<PackageManagerTabs
  command={{
    npm: 'npm create @lynx-js/lynx@latest my-lib -- --template rslib-react-ts',
    yarn: 'yarn create @lynx-js/lynx my-lib --template rslib-react-ts',
    pnpm: 'pnpm create @lynx-js/lynx@latest my-lib --template rslib-react-ts',
    bun: 'bun create @lynx-js/lynx@latest my-lib --template rslib-react-ts',
    deno: 'deno init --npm @lynx-js/lynx@latest my-lib --template rslib-react-ts',
  }}
/>
...
<PackageManagerTabs command="add @rstest/core @rstest/adapter-rslib @lynx-js/react-rsbuild-plugin @testing-library/dom @testing-library/jest-dom happy-dom -D" />
...
<PackageManagerTabs
  command={{
    npm: 'npm create @lynx-js/lynx@latest my-lib -- --template rslib-react-ts --tools external-bundle',
    yarn: 'yarn create @lynx-js/lynx my-lib --template rslib-react-ts --tools external-bundle',
    pnpm: 'pnpm create @lynx-js/lynx@latest my-lib --template rslib-react-ts --tools external-bundle',
    bun: 'bun create @lynx-js/lynx@latest my-lib --template rslib-react-ts --tools external-bundle',
    deno: 'deno init --npm @lynx-js/lynx@latest my-lib --template rslib-react-ts --tools external-bundle',
  }}
/>
...
<PackageManagerTabs command="run build:external-bundle" />
