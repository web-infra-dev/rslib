---
description: 'Use CSS in Rslib with CSS Modules, preprocessors, PostCSS, Lightning CSS, and output configuration.'
---
...
If your project already has a PostCSS setup, you can also install `tailwindcss` and `@tailwindcss/postcss`, then register the Tailwind CSS PostCSS plugin via [postcss.config.mjs](https://npmjs.com/package/postcss-loader#config) or [tools.postcss](/config/rsbuild/tools#toolspostcss).
