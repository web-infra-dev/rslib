---
description: '在 Rslib 项目中使用 Rspress，构建组件文档、示例演示、API 页面与完整文档站点体验。'
---
...
模板中内置了 [rsbuild-plugin-workspace-dev](https://github.com/rstackjs/rsbuild-plugin-workspace-dev) 插件，可在启动 Rspress 开发服务器的同时启动 Rslib 的 watch 模式。
