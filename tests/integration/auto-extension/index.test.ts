...
describe('should respect output.filename.js and output.filenameHash to override builtin logic', () => {
  test('type is commonjs', async () => {
    ...
    expect(entryFiles.cjs0).toMatchInlineSnapshot(
      `"<ROOT>/tests/integration/auto-extension/type-commonjs/config-override/dist/cjs-override-filename/index.d26be75738.js"`,
    );
    ...
    expect(entryFiles.cjs1).toMatchInlineSnapshot(
      `"<ROOT>/tests/integration/auto-extension/type-commonjs/config-override/dist/cjs-override-filename-hash/index.d26be75738.js"`,
    );
  ...
  test('type is module', async () => {
    ...
    expect(entryFiles.cjs1).toMatchInlineSnapshot(
      `"<ROOT>/tests/integration/auto-extension/type-module/config-override/dist/cjs-override-filename-hash/index.d26be75738.js"`,
    );
