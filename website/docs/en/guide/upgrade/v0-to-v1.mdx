...
Rslib v1 changes how Rsbuild's default environment variable presets are handled:
...
If a value must be fixed when building the library, define it explicitly with [source.define](https://rsbuild.rs/guide/advanced/env-vars#using-define):
