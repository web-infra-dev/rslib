...
目前 Rstack 工具链中的 Rspack / Rsbuild / Rspress 等项目已经使用 Rslib 进行构建，周下载量数万，在字节内部已经服务了多个业务，同时也是 Module Federation 模块的 [推荐解决方案](https://module-federation.io/zh/integrations/build-tool/rslib)。
