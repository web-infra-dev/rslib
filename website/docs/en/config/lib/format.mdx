---
description: 'Configure lib.format to choose Rslib output formats such as ESM, CJS, UMD, Module Federation, and IIFE.'
---
...
The output format affects some of Rslib's default behavior. See [Default behavior](/config/default-behavior) for details.
