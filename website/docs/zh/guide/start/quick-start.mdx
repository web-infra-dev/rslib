...
| [React Compiler](https://react.dev/learn/react-compiler/introduction) | React Compiler 编译优化，仅 React 模板 |
...
# 为 React 模板启用 React Compiler
npx -y create-rslib@latest my-project -t react --tools react-compiler
...
Optional tools:
  eslint, rslint, biome, prettier, rspress, storybook, rstest, react-compiler
