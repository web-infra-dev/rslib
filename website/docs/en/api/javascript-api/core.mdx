...
- `onAfterCreateRsbuild`: The callback function called after creating the Rsbuild instance, where you can perform some custom operations on the Rsbuild instance.
...
### Modify Rsbuild instance

The `onAfterCreateRsbuild` option of `createRslib` allows you to modify the Rsbuild instance after it is created, such as calling some Rsbuild APIs.
