...
If you want to enable React Compiler in the scaffolded project, select `React Compiler` in optional tools, or use `--tools react-compiler` in non-interactive mode.
