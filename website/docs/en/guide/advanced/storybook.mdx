...
1. Install the dependencies for Storybook Rsbuild React framework. The essential ones include
   ...
   <PackageManagerTabs
     command={{
       npm: 'npm add storybook@8 @storybook/addon-essentials storybook-addon-rslib @rsbuild/core -D',
       yarn: 'yarn add storybook@8 @storybook/addon-essentials storybook-addon-rslib @rsbuild/core -D',
       pnpm: 'pnpm add storybook@8 @storybook/addon-essentials storybook-addon-rslib @rsbuild/core -D',
       bun: 'bun add storybook@8 @storybook/addon-essentials storybook-addon-rslib @rsbuild/core -D',
     }}
   />
