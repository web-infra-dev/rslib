...
describe('output config', () => {
  describe('chunkFileName', () => {
    test('should prefix index for multi-compiler builds', async () => {
      ...
      expect(esm0BaseNames.some((n) => /^0~111\.js$/.test(n))).toBeTruthy();
      expect(esm1BaseNames.some((n) => /^1~111\.js$/.test(n))).toBeTruthy();
    });
    ...
    test('should prefix index for multi-compiler builds (with filename)', async () => {
      ...
      expect(
        esm0BaseNames.some((n) => /^0~111\.\w+\.js$/.test(n)),
      ).toBeTruthy();
      expect(
        esm1BaseNames.some((n) => /^1~111\.\w+\.js$/.test(n)),
      ).toBeTruthy();
    });
    ...
    test('should prefix index for multi-compiler builds (with chunkFilename)', async () => {
      ...
      expect(
        files.esm0!.some((n) => /static1\/js\/0~111\.js$/.test(n)),
      ).toBeTruthy();
      expect(
        files.esm0!.some((n) => /static1\/js\/lib1\.js$/.test(n)),
      ).toBeTruthy();
      expect(
        files.esm0!.some((n) => /static2\/js\/1~111\.\w+\.js$/.test(n)),
      ).toBeTruthy();
      expect(
