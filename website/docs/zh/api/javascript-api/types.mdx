---
description: '查看 Rslib 导出的 TypeScript 类型，涵盖配置、API、实例方法、插件接口以及 Rsbuild、Rspack 类型。'
---
...
[loadConfig](/api/javascript-api/core#loadconfig) 方法的入参类型。

```ts twoslash
import type { LoadConfigOptions, LoadConfigResult } from '@rslib/core';

const options: LoadConfigOptions = {
  configFileNames: ['framework.config.ts'],
};
