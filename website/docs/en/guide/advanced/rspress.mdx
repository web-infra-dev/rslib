...
Rslib and Rspress can be generated together via `create-rslib`. When creating a project, you can choose the Rspress tool to quickly set up a docs site while building your component library.
...
```json title="package.json"
{
  "scripts": {
    ...
    "doc": "rspress dev" // run this
  }
}
```

Prepare a Rslib project with components first; see [Solutions](/guide/solution/).
