---
description: 'Use Storybook with Rslib for isolated component development, preview debugging, examples, and documentation workflows.'
---
...
:::tip
You can create a new project with Storybook already wired up via [create-rslib](/guide/start/quick-start#creating-an-rslib-project), without manual setup.
:::
